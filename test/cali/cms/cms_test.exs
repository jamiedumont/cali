defmodule Cali.CMSTest do
  ...
  describe "posts" do
    ...
    @valid_attrs %{content: "some content", date: ~D[2010-04-17], description: "some description", draft: true, slug: "some slug", title: "some title"}
    @update_attrs %{content: "some updated content", date: ~D[2011-05-18], description: "some updated description", draft: false, slug: "some updated slug", title: "some updated title"}
    @invalid_attrs %{content: nil, date: nil, description: nil, draft: nil, slug: nil, title: nil}
